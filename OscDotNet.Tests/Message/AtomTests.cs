...
namespace OscDotNet.Tests
{
  public class AtomTests
  {
    ...
    {
      var atom1 = new Atom("This is a test");
    ...
    {
      var atom1 = new Atom("Not a blob value");
